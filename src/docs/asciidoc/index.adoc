...
Dieses Dokument dient als Beispiel für eine Dokumentationsstruktur mit AsciiDoc.
Es ist spannend was AsciiDoc alles kann und wie einfach es zu bedienen sein wird!
